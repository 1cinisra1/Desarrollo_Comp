...
namespace GPSMonitoreo.Web.Controllers.General
{
	...
	/// </summary>
    public class MarcasModelosController: GeneralBaseController
    {
		public IActionResult Categoriastree()
		{

			return TreeView(
				"ADMINISTRACION::MARCAS Y MODELOS::CATEGORIAS MARCAS", 
				DBContext.CategoriesTree<MARCAS_CATS>(null, true).ToJqwidgetsTree(false),
				"App.general.marcasmodelos.categoriasedit"
				);
		}
	}
}
