...
{
    public class FormEditableGrid : ViewComponent
	{
		...
		public IViewComponentResult Invoke(Models.FormEditableGridModel model)
		{
			...
			return View("~/Views/Shared/Components/FormEditableGrid.cshtml", model);
		}
